...
<div class="login-box">
  <el-form :model="registedForm" status-icon :rules="rules2" ref="registedForm" class="form-box">
    ...
    <el-form-item  prop="pass">
      <el-input type="password" placeholder="请输入新密码" v-model="registedForm.pass" auto-complete="off"></el-input>
    </el-form-item>
    <el-form-item prop="checkPass">
      <el-input type="password" placeholder="请再次输入新密码" v-model="registedForm.checkPass" auto-complete="off"></el-input>
    </el-form-item>
